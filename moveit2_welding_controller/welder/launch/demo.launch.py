...
def generate_launch_description():
    namespace_arg = DeclareLaunchArgument(
        "namespace", default_value="welder", description="Namespace for the robot"
    )    
    ...
    rviz_config_arg = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory("welder"),
            "config",
            "moveit.rviz",
        ),
    ...
    moveit_config = (
        ...
        .robot_description(
            file_path="config/welder.urdf.xacro",
    ...
    ros2_control_node = Node(
        ...
        parameters=[os.path.join(get_package_share_directory("welder"), "config", "ros2_controllers.yaml")],
        remappings=[
    ...
    welder_planning_group_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["welder_planning_group_controller", "--controller-manager", "/controller_manager"],
    )
    ...
    return LaunchDescription([
        ...
        welder_planning_group_controller_spawner,
        mongodb_server_node,
