...
def generate_launch_description():
    ...
    positioner_robot_state_publisher = Node(
        ...
        name="positioner_robot_state_publisher",
        output="both",
    ...
    positioner_static_tf = Node(
        ...
        name="positioner_static_transform_publisher",
        output="log",
    ...
    welder_robot_state_publisher = Node(
        package="robot_state_publisher",
        executable="robot_state_publisher",
        name="welder_robot_state_publisher",
        output="both",
    ...
    welder_static_tf = Node(
        package="tf2_ros",
        executable="static_transform_publisher",
        name="welder_static_transform_publisher",
        output="log",
